...
const ContactPage: NextPage = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex h-[calc(100vh-4rem)] items-center justify-center bg-gray-50 dark:bg-slate-900">
        <div className="flex flex-col items-center gap-4">
          <div className="h-10 w-10 animate-spin rounded-full border-4 border-gray-900 dark:border-gray-100 border-t-transparent dark:border-t-transparent"></div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 pb-20 pt-10">
