...
const UserDropdown: React.FC<UserProps> = () => {
  ...
  return (
    <div className="w-72 p-4 rounded-xl shadow-xl bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700">
      <div className="flex flex-col gap-3 justify-center items-center">
        <Image
          className="rounded-full p-1 w-16 h-16 ring-2 ring-gray-200 dark:ring-slate-600"
          src={
            session?.user?.image ||
      ...
      <div className="flex flex-col gap-1">
        ...
        <button
          onClick={() => signOut()}
          className="flex items-center gap-3 text-red-600 dark:text-red-400 text-sm font-medium hover:bg-red-50 dark:hover:bg-red-900/20 p-3 rounded-lg transition-colors cursor-pointer w-full text-left"
        >
