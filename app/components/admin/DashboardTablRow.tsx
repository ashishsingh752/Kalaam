    ...
    <tr className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
        ...
        <div className="flex items-center">
          <div className="flex-shrink-0 h-10 w-10">
            {user.image ? (
              ...
              <div className="h-10 w-10 rounded-full bg-gray-200 dark:bg-slate-600 flex items-center justify-center text-gray-500 dark:text-gray-300 font-bold">
      ...
      <td className="px-6 py-4 whitespace-nowrap">
        <select
          ...
          title="Select Role"
          className="block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-gray-100 focus:outline-none focus:ring-black dark:focus:ring-indigo-500 focus:border-black dark:focus:border-indigo-500 sm:text-sm rounded-md"
          value={selectedRole}
